...
import { signup, setAuth, getAndClearLastPage } from '../api';
...
const Signup = ({ onSwitchToLogin, onSignupSuccess }) => {
  ...
  return (
    <>
      <div className="max-w-lg size-fit bg-white p-8 rounded-lg shadow-lg">
        <h2 className="text-2xl font-bold mb-2 text-center text-gray-800">Create Account</h2>
        <p className="mb-6 text-center text-gray-600">Sign up to get started</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex gap-2 m-px-0">
            <input
              type="text"
              id="firstName"
              name="firstName"
              ...
              className="flex-1 px-2 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-600"
            />
            <input
              type="text"
              id="lastName"
